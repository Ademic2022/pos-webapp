...
export const salesData: SalesData[] = [
  ...
  export const products: Record<SaleType, Product[]> = {
    ...
    retail: [
      ...
      { id: "keg_2", name: "2 Kegs", price: 3000, stock: 63, unit: "2" },
      { id: "keg_3", name: "3 Kegs", price: 4500, stock: 42, unit: "3" },
      { id: "keg_4", name: "4 Kegs", price: 6000, stock: 31, unit: "4" },
      { id: "keg_5", name: "5 Kegs", price: 7500, stock: 25, unit: "5" },
      { id: "keg_6", name: "6 Kegs", price: 9000, stock: 21, unit: "6" },
      { id: "keg_7", name: "7 Kegs", price: 10500, stock: 18, unit: "7" },
      { id: "keg_8", name: "8 Kegs", price: 12000, stock: 18, unit: "8" },
    ],
  };
