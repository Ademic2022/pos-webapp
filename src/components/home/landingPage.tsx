          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Complete POS solution designed specifically for groundnut oil
                companies. Manage wholesale and retail operations seamlessly
                with real-time inventory, smart analytics, and automated
                workflows.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              ...
              <span className="text-amber-600">Scale Your Business</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our comprehensive POS system is built specifically for oil
              companies, handling both wholesale and retail operations with
              precision and ease.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Seamlessly manage both wholesale and retail transactions with customized pricing tiers and bulk discount calculations.",
              ...
              },
              {
                ...
                description:
                  "Get instant insights into sales performance, inventory turnover, and profit margins with beautiful, actionable dashboards.",
              ...
              },
              {
                ...
                description:
                  "Build stronger relationships with advanced customer profiles, purchase history, and automated loyalty programs.",
              ...
              },
              {
                ...
                description:
                  "Track oil quality parameters, batch numbers, and expiry dates to ensure premium product standards.",
              ...
              },
              {
                ...
                description:
                  "Smart reorder points, automated stock alerts, and supplier management to never run out of products.",
              ...
              },
              {
                ...
                description:
                  "Process transactions in seconds with offline capability and instant receipt generation for uninterrupted service.",
